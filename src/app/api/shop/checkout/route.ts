...
type Item = { id: string; name: string; quantity: number; price: number; tag: string };
  ...
  try {
    const result = await postToGhl({
      ...
      order: {
        ...
        ghlProductIds: {
          aegean: process.env.GHL_PRODUCT_AEGEAN || "",
          ember: process.env.GHL_PRODUCT_EMBER || "",
          fiesta: process.env.GHL_PRODUCT_FIESTA || "",
          garden: process.env.GHL_PRODUCT_GARDEN || "",
          mustard: process.env.GHL_PRODUCT_MUSTARD || "",
          trio: process.env.GHL_PRODUCT_TRIO || "",
          tote: process.env.GHL_PRODUCT_TOTE || "",
          spice: process.env.GHL_PRODUCT_SPICE || "",
        },
      },
